...
/****** Image Class ******
* Gets the prominent colors in a given image. To get common color matching, all pixels are matched against a whitelist
* color palette.
* 
* @author				Joe Hoyle (joe@hmn.md)
* @author's notes		Props to the following people who I ripped some of this code from: Marc Pacheco
* 
****** Example of Use ******

// Get Image Colors
$imageColors = new ImageColorTest($imagePath);
